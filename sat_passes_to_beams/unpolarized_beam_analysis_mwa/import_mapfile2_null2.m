...
function [za,az,tileew,refew,tilens,refns,refmodelew,refmodelns,satnum,passnum,hours,pixnums]=import_mapfile2_null2(nsides)

    disp('importing Null2...');

    root='/Users/abrahamn/data/21cm/sat_cal/updates/2013/may12/null2_newbacksub/';
    mapfilename='mapfileNull2_refpolbeams_snrfilt';
    disp([root,mapfilename]);

    rawdat=importdata([root,mapfilename],' ',20);
    dat=rawdat.data;
