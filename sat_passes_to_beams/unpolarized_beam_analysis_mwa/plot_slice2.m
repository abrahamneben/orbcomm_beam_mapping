function plot_slice2(tiledata,sliceangle,plottitle,nsides,maxewind,counts,pol,tilemodelboresightgain,delaynums,linesty) % pol is 'ew' or 'ns'
    ...
    plot(xsort,data(xsortind),[col,linesty],'LineWidth',2,'MarkerSize',3);hold on;
    plot([-100 100],[0 0],'k','MarkerSize',14);hold on;
    plot(-23./2+[.001,.0011],[-30,30],'k:',23./2+[.001,.0011],[-30,30],'k:');
    title(plottitle);xlim([-80 80]);ylim([-2.5 3.5]);
