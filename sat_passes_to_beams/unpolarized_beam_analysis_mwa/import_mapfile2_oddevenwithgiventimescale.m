...
function [za,az,tileew,refew,tilens,refns,refmodelew,refmodelns,satnum,passnum,hours,pixnums]=import_mapfile2_oddevenwithgiventimescale(label,nsides,oddeven,interleavinghours)
    ...
    allhours = dat(:,17);
    g = find( mod(round(allhours/interleavinghours)+oddeven,2) );
