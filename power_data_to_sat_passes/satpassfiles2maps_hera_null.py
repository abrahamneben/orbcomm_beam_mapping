...
def logchan_power(string_amplitudes):
	amps = map(float,string_amplitudes) # coherent sum
...
#GB
satpassdir = "/export/data_2/rbradley/data/hera/composite_" + mapfilesuffix + "/"
satcalanalysisroot = "/export/data_1/rbradley/satcalanalysis/"
