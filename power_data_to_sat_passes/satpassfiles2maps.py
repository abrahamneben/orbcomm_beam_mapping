...
if len(argv)!=3:
	print 'Usage: ./satpassfiles2maps.py mapfilesuffix pointing'
	sys.exit(1)
...
#GB
satpassdir = "/export/data_2/aneben/phase4/composite_" + mapfilesuffix + "/"
...
#pointing = mapfilesuffix
#pointing = 'E01S00'
print 'Using tile pointing '+pointing

tilemodelarrNS = makemodelarr(satcalanalysisroot+'tileModel/tileNS_'+pointing+'.tsv')
tilemodelarrEW = makemodelarr(satcalanalysisroot+'tileModel/tileEW_'+pointing+'.tsv')
...
for satpassdatafilename in satpassdatafilenames:
	...
	for recordi in range(len(satpassdata)/5):
			...
			mapfile.write('%1.2f %1.2f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %1.4f %d %d %1.4f %s\n'%(	za, az, \
