	  ...
	  for (Mcount=0; Mcount<M; Mcount++)
	    {
	      ...
	      if (plan) p2=fftw_plan_dft_r2c_1d(N, timedata2, freqdata2, FFTW_FORWARD);
	      if (plan) p3=fftw_plan_dft_r2c_1d(N, timedata3, freqdata3, FFTW_FORWARD);
	      if (plan) p4=fftw_plan_dft_r2c_1d(N, timedata4, freqdata4, FFTW_FORWARD);
